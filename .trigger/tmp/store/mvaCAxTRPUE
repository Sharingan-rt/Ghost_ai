import {
  ...
  generateText,
  tool
} from "./chunk-NU5X5GRQ.mjs";
import "./chunk-ACD6INJO.mjs";
import {
  external_exports,
  task
} from "./chunk-ANLMXLGX.mjs";
import "./chunk-XJOO6QUR.mjs";
import {
  __commonJS,
  __name,
  __toESM,
...
async function fetchPolyfill() {
  return typeof globalThis.fetch !== "undefined" ? globalThis.fetch : (await import("./lib-EDDVHTKH.mjs")).default;
}
